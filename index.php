...
<head>
	...
	<title>سامانه رزرو نوبت استخر</title>
...
<section id="home">
	<div class="carousel-caption">
		<h5>سامانه رزرو نوبت استخر</h5>
		<p>روشی آسان برای رزرو آنلاین سانس استخر؛ سریع، راحت و بدون دردسر</p>
		<p><a class="btn btn-warning mt-3" href="booking.php">همین حالا رزرو کنید</a></p>
	</div>
		...
		<div class="row">
			...
			<div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
				<div class="about-text">
					<h2>
						کارآمدترین روش برای<br>
						رزرو آنلاین سانس‌های استخر
					</h2>

					<p>
						سیستمی خودکار برای رزرو آنلاین سانس‌ها. بدون اتلاف وقت و بدون نیاز به مراجعه حضوری
					</p>

					<a class="btn btn-warning" href="#">بیشتر بدانید</a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="col-md-12">
				<div class="section-header text-center pb-5 qform">
					...
					<form action="query.php" method="post">
						...
						<div class="qform-group">
							<input type="text" name="sub" placeholder="موضوع پیام" required>
						</div>

						<div class="qform-group">
							<input type="text" name="msg" placeholder="متن پیام" required>
						</div>
...
<footer class="bg-dark p-2 text-center">
	<div class="container">
		<p class="text-white">استخر IUB - ۲۰۲۲</p>
	</div>
</footer>
<!-- footer ends -->
